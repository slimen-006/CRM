...
export class ProfilClientComponent implements OnInit {
  ...
  constructor(
    ...
    private adminServiceService :ClientService,
  ...
  onUpdateSuperUserInterne() {
    ...
    if (this.profilFormSuperUserInterne.valid) {
      ...
      const updatedUserInterneTechncien: any = {
        id: this.userConnectedById.client.id,
    ...
    this.userService.findById(id).subscribe({
      next: (result: UserConnected) => {
        ...
        this.profilFormSuperUserInterne.patchValue({
          ...
          telephone: result.client?.telephone || '', // Utilisez le ? pour éviter les erreurs si client est null
